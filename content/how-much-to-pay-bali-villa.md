---
question: How much should you actually pay for a Bali villa?
summary: Work backwards from the return you need. The price that makes a deal work is often well below the asking price.
category: rental
order: 08
risk: medium
regulation: Market analysis
applies: Buyers negotiating price
verified: 2026-08-14
---
...
The [calculator](/calculator/) does steps 1 to 4 — adjust the price until the net yield reaches your number.
...
- Missing PBG or SLF, where [legalisation takes 8–12 months and may not be possible](/building/legalise-villa-without-permit/)
- Short remaining lease term
- Zoning that does not permit the intended use
- Any structure relying on a nominee arrangement
- A projection that only works above 70% occupancy
